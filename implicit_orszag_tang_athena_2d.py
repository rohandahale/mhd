...
"""
The purpose of this program is to apply the code to propagate the orszag-tang vortex implicitly, a 2D ideal MHD problem, in incompressible form.
...
if my_fluid.cycle_start == 1:
	...
	A 	= np.zeros((my_fluid.NX,my_fluid.NY)) # magnetic vector potential
